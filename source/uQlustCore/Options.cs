...
namespace uQlustCore
{
    ...
    public class Options:IAutomaticProfiles
    {
        ...
        {
            string defaultFile = "default.options";
            //string dir = Environment.GetEnvironmentVariable("CLUSTER");
            string dir = Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location);

            if (dir != null)
                defaultFile = dir + Path.DirectorySeparatorChar + defaultFile;
        ...
        public void ReadOptionFile(string fileName)
        {
            ...
            {   
                ...
                DebugMode.WriteMessage("Start reading " + fileName);
                while(!r.EndOfStream)
                {
                    line = r.ReadLine();
            ...
            DebugMode.WriteMessage("Reading finished");
